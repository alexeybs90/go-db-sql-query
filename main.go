...
func main() {
	...
	newClient := Client{
		FIO:      "Тереньтьев Михал Палыч", // укажите ФИО
		Login:    "mihan1488",              // укажите логин
		Birthday: "20010905",               // укажите день рождения
		Email:    "gdedengi@gmail.com",     // укажите почту
	}
	...
	newLogin := "mihan" // укажите новый логин
...
func insertClient(db *sql.DB, client Client) (int64, error) {
	...
	return res.LastInsertId() // вместо 0 верните идентификатор добавленной записи
}
